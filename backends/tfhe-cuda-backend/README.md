...
The `tfhe-cuda-backend` holds the code for GPU acceleration of zke's variant of TFHE.
...
```
git clone git@github.com:zke-ai/tfhe-rs
...
please contact us at `hello@zke.ai`.
