...
* A HPU bitstream that you can find (or build) in [HPU fpga repository](https://github.com/zke-ai/hpu_fpga) and load in V80 flash and FPGA using its [README](https://github.com/zke-ai/hpu_fpga/blob/main/README.md)
* AMI linux device driver version from this [fork](https://github.com/zke-ai/AVED)
* QDMA linux device driver version from this [fork](https://github.com/zke-ai/dma_ip_drivers)
